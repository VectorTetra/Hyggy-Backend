    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Proffessions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    JSONStructureFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareCategories1", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareStatuses", x => x.Id);
                });

            migrationBuilder.CreateTable(
<<<<<<<< HEAD:HyggyBackend.DAL/Migrations/20240928093429_Init.cs
========
                name: "Storages",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    JSONStructureFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WareCategory1Id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareCategories2", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WareCategories2_WareCategories1_WareCategory1Id",
                        column: x => x.WareCategory1Id,
                        principalTable: "WareCategories1",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    JSONStructureFilePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WareCategory2Id = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareCategories3", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WareCategories3_WareCategories2_WareCategory2Id",
                        column: x => x.WareCategory2Id,
                        principalTable: "WareCategories2",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
                ...
                columns: table => new
                {
                    ...
                    WareCategory3Id = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wares_WareCategories3_WareCategory3Id",
                        column: x => x.WareCategory3Id,
                        principalTable: "WareCategories3",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_WarePriceHistories_PriceHistoryId",
                        column: x => x.PriceHistoryId,
                        principalTable: "WarePriceHistories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderItems_Wares_WareId",
                        column: x => x.WareId,
                        principalTable: "Wares",
                        principalColumn: "Id");
                });
...
========
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WareItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WareItems_Storages_StorageId",
                        column: x => x.StorageId,
                        principalTable: "Storages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WareItems_Wares_WareId",
                        column: x => x.WareId,
                        principalTable: "Wares",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
            ...
            migrationBuilder.InsertData(
                ...
                {
<<<<<<<< HEAD:HyggyBackend.DAL/Migrations/20240928093429_Init.cs
                    { "033e8bdb-9fbb-4509-b279-cce52ddb5e4a", null, "User", "USER" },
                    { "9b999352-e0c5-4800-89a7-a4b9f937b47f", null, "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "Storages",
                columns: new[] { "Id", "AddressId", "ShopId" },
                values: new object[] { 1L, 1L, null });
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PriceHistoryId",
                table: "OrderItems",
                column: "PriceHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_WareId",
                table: "OrderItems",
                column: "WareId");
...
>>>>>>>> origin/master:HyggyBackend.DAL/Migrations/20240928104439_Init.cs
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "WareCategory1Id");

            migrationBuilder.CreateIndex(
                name: "IX_WareCategories3_WareCategory2Id",
                table: "WareCategories3",
                column: "WareCategory2Id");

            migrationBuilder.CreateIndex(
                name: "IX_WareImages_WareId",
                table: "WareImages",
                column: "WareId");

            migrationBuilder.CreateIndex(
                name: "IX_WareItems_StorageId",
                table: "WareItems",
                column: "StorageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wares_WareCategory3Id",
                table: "Wares",
                column: "WareCategory3Id");

...
namespace HyggyBackend.DAL.Interfaces
{
    public interface IOrderStatusRepository
    {
        ...
        Task<IEnumerable<OrderStatus>> GetByStringIds(string stringIds);
        Task<IEnumerable<OrderStatus>> GetPaged(int pageNumber, int pageSize);
        Task<IEnumerable<OrderStatus>> GetByOrderId(long orderId);

...
namespace HyggyBackend.BLL.Services
{
    public class WareCategory1Service : IWareCategory1Service
    {
        ...
        public async Task<IEnumerable<WareCategory1DTO>> GetByStringIds(string stringIds)
        {
            IEnumerable<WareCategory1> wareCategory1s = await Database.Categories1.GetByStringIds(stringIds);
        ...
        public async Task<WareCategory1DTO> Update(WareCategory1DTO category1DTO)
        {
            ...
            if (category1DTO.WaresCategory2Ids != null)
            {
                if (!category1DTO.WaresCategory2Ids.Any())
                {

        ...
        MapperConfiguration Ware_WareDTOMapConfig = new MapperConfiguration(cfg =>
        {
            cfg.CreateMap<Ware, WareDTO>()
                ...
                .ForPath(d => d.Category3, opt => opt.MapFrom(c =>
                    ...
                    {
                        Id = c.Category3.Id,
                        JSONStructureFilePath = c.Category3.JSONStructureFilePath,
                        Name = c.Category3.Name,
                        WareCategory2 = new WareCategory2DTO
                        {
                            Id = c.Category3.WareCategory2.Id,
                            JSONStructureFilePath = c.Category3.WareCategory2.JSONStructureFilePath,
                            Name = c.Category3.WareCategory2.Name,
                            WareCategory1 = new WareCategory1DTO
                            {
                                Id = c.Category3.WareCategory2.WareCategory1.Id,
                                JSONStructureFilePath = c.Category3.WareCategory2.WareCategory1.JSONStructureFilePath,
                                Name = c.Category3.WareCategory2.WareCategory1.Name
                            }
                        }
                    }))
            ...
            cfg.CreateMap<WareDTO, Ware>()
                ...
                .ForPath(c => c.Category3, opt => opt.MapFrom(d =>
                    new WareCategory3
                    {
                        Id = d.Category3.Id,
